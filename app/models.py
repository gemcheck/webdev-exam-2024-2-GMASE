...
class Books(Base):
    ...
    id_cover: Mapped[int] = mapped_column(ForeignKey('covers.id_cover'))
...
class ConnectGenreBook(Base):
    ...
    id_book: Mapped[int] = mapped_column(ForeignKey('books.id_book'), primary_key=True)
    id_genre: Mapped[int] = mapped_column(ForeignKey('genres.id_genre'), primary_key=True)
